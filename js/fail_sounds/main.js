...
gameMain.prototype = {
    create: function(){  
        ...
        button2 = buttonsGroup.create(253, 15, 'button');
        button3 = buttonsGroup.create(483, 15, 'button');
        button4 = buttonsGroup.create(20, 235, 'button');
        button5 = buttonsGroup.create(253, 235, 'button');
        button6 = buttonsGroup.create(483, 235, 'button');
        
        button7 = this.add.sprite(726, 17, 'button');
        button7.scale.set(0.5, 0.5);
        button7.tint = 0xffff00;
        button7.alpha = 0.9;
        
        button8 = this.add.sprite(685, 175, 'button');
        button8.scale.set(0.6,0.6);
        button8.tint = 0xffff00;
        button8.alpha = 0.9;
        
        cricket = this.add.image(63, 104, 'cricket');
        drums = this.add.image(285,70, 'drums');
        horn = this.add.image(525, 90, 'horn');
        jaws_harp = this.add.image(75, 290, 'random');
        mask = this.add.image(320, 255, 'mask');
        trombone = this.add.image(527, 282, 'trombone');
        ...
        gearBtn = this.add.sprite(740, 32,'gear');
        gearBtn.alpha = 0.9;
        
        knowBtn = this.add.sprite(747, 240,'bulb');
        knowBtn.alpha = 0.9;
...
function openOptions(){
    ...
    modal.createModal({
        ...
        itemsArr: [
            ...
            {
                type: "text", content: "Random", fontSize: optionsFontSize, color: optionsColor,
                offsetY: 20, offsetX: 220,
...
function didYouKnow(){
    ...
    "Set the timer to random\nto play the sound\nat a random time\nbetween 2 & 60 seconds",
    "Atychiphobia - \nThe fear of failure",
    "Everybody fails",
    "This app is completely free!\.\nYou could rate it if you like.\n:)",
